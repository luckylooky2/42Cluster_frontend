...
bash delete_dashboard.sh m0c121a26444b636a3fd509a8efa86fd # cluster-node.json
bash delete_dashboard.sh md0c121a26444b636a3f509a8efa86fd # cluster-namespace.json
...
bash delete_dashboard.sh mb0d919ec0ea5f6543124e16c42a5a87 # service-oveview.json

bash delete_dashboard.sh d595cac94cda1b36fc103b78a9e33f47 # project-overview.json
bash delete_dashboard.sh d87670baea6a8ba5d368cd85bef0fbd3 # application-overview.json
